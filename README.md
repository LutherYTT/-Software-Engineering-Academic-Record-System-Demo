...
If you are using other platforms(eg. vs vode) to run the Academic-Registry-Portal.ipynb, you need to install PySimpleGUI==4.60.5 and pandas==1.4.4 by yourself on terminal.
