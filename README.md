...
If you are using other platforms to run the Academic-Registry-Portal.ipynb(eg. vs vode), you need to install PySimpleGUI==4.60.5 and pandas==1.4.4 by yourself on terminal.
